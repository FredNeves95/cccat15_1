...
export default class Account {
  private constructor(readonly accountId: string, readonly name: string, readonly email: string, readonly cpf: string,
    readonly isDriver: boolean, readonly isPassenger: boolean, readonly carPlate?: string){
